  ...
  var gameOver,gameOverImage,reload,reloadImage;
  //score variable
  var score;
  //groups
  ...
  if((touches.lenght>0||fruitGroup.isTouching(sword))){
  ...
  gameOver=createSprite(width/2,300,100,10);
  gameOver.addImage(gameOverImage);
  gameOver.scale=2.0
  //creating RESTART sprite     
  restart=createSprite(width/2,350,100,10);
